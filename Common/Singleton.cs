...
namespace LeopotamGroup.Common {
    ...
    public abstract class UnitySingletonBase : MonoBehaviour {
        void Awake () {
            ...
            if (attrs != null && attrs.Length > 0) {
                ...
                for (; i >= 0; i--) {
                    if (System.Text.RegularExpressions.Regex.IsMatch (sceneName, (attrs[i] as UnitySingletonSceneFilterAttribute).Name)) {
                        break;
                    }
                }
                if (i == -1) {
                    throw new UnityException (string.Format ("\"{0}\" singleton cant be used at scene \"{1}\"", type.Name, sceneName));
                }
            }
#endif
    ...
    public static class Singleton {
        static readonly Dictionary<Type, System.Object> _instancesPool = new Dictionary<Type, System.Object> (32, new KeysComparer ());
        ...
        public static bool IsInstanceRegistered (System.Object instance) {
            if (instance != null) {
        ...
        public static T Get<T> () where T : class, new() {
            ...
            if (!Application.isPlaying) {
                throw new UnityException (string.Format ("UnitySingleton<{0}> can be used only at PLAY mode", type.Name));
            }
#endif
        ...
        /// <param name="forceRegister">Force unregister old instance and destroy if exists, then register new one.</param>
        public static void Register (System.Object instance, Type targetType = null, bool forceRegister = false) {
            if ((System.Object) instance == null) {
                throw new UnityException (
                    string.Format ("Cant register instance of \"{0}\" as singleton of type \"{1}\" - instance is null",
            ...
            if (instanceType != targetType && !instanceType.IsSubclassOf (targetType)) {
                throw new UnityException (
                    string.Format ("Cant register instance of \"{0}\" as singleton of type \"{1}\" - invalid target type",
                        instanceType.Name, targetType != null ? targetType.Name : "null"));
            }
            var isTargetTypeRegistered = IsTypeRegistered (targetType);
            if (isTargetTypeRegistered) {
                if (!forceRegister) {
                    throw new UnityException (
                        string.Format ("Cant register instance of \"{0}\" as singleton of type \"{1}\" - target type already registered",
        ...
        /// </summary>
        /// <param name="instance">Instance.</param>
        public static void Unregister (System.Object instance) {
            if (instance != null) {
                foreach (var pair in _instancesPool) {
                    if (pair.Value == instance) {
